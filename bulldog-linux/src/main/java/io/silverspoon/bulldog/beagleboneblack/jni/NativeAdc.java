...
public class NativeAdc {
   ...
   /**
 * @deprecated Use {@link NativePwm#BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT} instead
 */
public static final int BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT = NativePwm.BBBIO_ADC_STEP_MODE_SW_ONE_SHOOT;
